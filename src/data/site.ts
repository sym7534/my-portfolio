...
export const BIO =
  "full-stack robotics engineer — from ROS 2 to firmware to CAD to manufactured parts. taking systems from shower thought to fully fleshed autonomy.";
...
/** Temporarily unlinked — the resume link is removed from LinksRow for now. */
